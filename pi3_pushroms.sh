...
REJECTS='+(1943mii|3in1semi|4dwarrio|4in1boot|atomicp|bakutotu|blazer|boxyboy|brain|bwcasino|cannonbp|catacomb|chinatwn|cleopatr|cookbib2|cookbib3|crswd2bl|cupfinal|dakkochn|dangseed|dbzvrvs|deerhunt|dmnfrnt|dokaben|dragonsh|dremshpr|drgnbowl|drgw2|dw2001|dwpc|eggor|euroch92|faceoff|fantastc|finalap2|finalttr|finehour|gardia|godzilla|gunlock|hal21|happy6|hvymetal|hwrace|hyperpac|imsorry|intcup94|isgsm|ixion|janshin|jdreddp|jitsupro|jockeygp|jpark|jpopnics|killbld*|kirameki|korokoro|koshien|kov*|kyukaidk|landmakr|legend|lightbr|lottofun|luctoday|madshark|majtitle|martmast|mastkin|metlhawk|mmaze|mmonkey|moremore|moremorp|moshougi|mrtnt|neobattl|oisipuzl|olds*|orbitron|ordyne|orlegend|pbobble|pbobble2|penbros|pgm|photoy2k|pisces|pistoldm|prmrsocr|puchicar|puzlstar|puzzli2|pwrgoal|pzlbowl|pzlbreak|quester|raflesia|razmataz|rocktrv2|roishtar|rompers|ryujin|ryukyu|sbm|sdtennis|sf2t|sfposeid|sfx|sfzch|shadowld|shinfz|shootgal|sjryuko|skybase|snapper|snowbro3|sokonuke|spacecr|spaceskr|spatter|spcfrcii|spclforc|spdball|spdcoin|srdmissn|stakwin*|supbtime|superbon|suzuk*|svg|sws*|tdpgal|tetrsark|theglad|tokisens|toppyrap|toryumon|toto|trophyh|trstar|tstrike|twinkle|twinqix|ufosensi|umanclub|utoukond|vanvan|vliner|vshoot|waterski|wits|wldcourt|wmatch|wofch|woodpeck|worldwar|ws|wtennis|wwallyj)'
