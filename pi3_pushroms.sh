...
REJECTS='+(1943mii|3in1semi|4in1boot|crswd2bl|dokaben|dmnfrnt|dragonsh|drgnbowl|drgw2|dw2001|dwpc|fantastc|happy6|isgsm|ixion|janshin|jockeygp|killbld*|korokoro|kov*|legend|lottofun|luctoday|martmast|mastkin|moremorp|olds*|moshougi|orbitron|orlegend|pbobble|pbobble2|pgm|pisces|photoy2k|puzlstar|puzzli2|rocktrv2|ryukyu|sbm|sf2t|sfzch|shinfz|snowbro3|spcfrcii|spclforc|spdball|spdcoin|stakwin*|superbon|suzuk*|svg|sws*|theglad|tdpgal|tokisens|toto|tstrike|twinqix|vliner|wofch)'
