...
REJECTS='+(1943mii|3in1semi|3stooges|4dwarrio|4in1boot|atomicp|bakutotu|blazer|boxyboy|brain|bwcasino|cannonbp|catacomb|chinatwn|cleopatr|cookbib2|cookbib3|crswd2bl|cupfinal|curvebal|dakkochn|dangseed|dbzvrvs|deerhunt|dmnfrnt|dokaben|dragonsh|dremshpr|drgnbowl|drgw2|dw2001|dwpc|eggor|euroch92|f1*|faceoff|fantastc|finallap|finalap*|finalttr|finehour|gardia|godzilla|gunlock|hal21|happy6|hvymetal|hwrace|hyperpac|imsorry|intcup94|isgsm|ixion|janshin|jdreddp|jitsupro|jockeygp|jpark|jpopnics|killbld*|kirameki|korokoro|koshien|kov*|krull|kyukaidk|landmakr|legend|lightbr|lottofun|luctoday|mach3|madshark|martmast|mastkin|metlhawk|mmaze|mmonkey|moremore|moremorp|moshougi|mplanets|mrtnt|neobattl|oisipuzl|olds*|othldrby|orbitron|ordyne|orlegend|pbobble|pbobble2|penbros|pgm|photoy2k|pisces|pistoldm|prmrsocr|ptblank|puchicar|puzlstar|puzzli2|pwrgoal|pzlbowl|pzlbreak|qbertqub|quester|raflesia|razmataz|rbislande|reactor|rocktrv2|roishtar|rompers|ryujin|ryukyu|sbm|scross|sdtennis|sf2t|sfposeid|sfx|sfzch|shadowld|shinfz|shootgal|sjryuko|skybase|snapper|snowbro3|sokonuke|spacecr|spaceskr|spatter|spcfrcii|spclforc|spdball|spdcoin|srdmissn|stakwin*|supbtime|superbon|suzuk*|svg|sws*|tdpgal|tetrsark|theglad|tokisens|toppyrap|toryumon|toto|trophyh|trstar|tstrike|turkhunt|twinkle|twinqix|ufosensi|umanclub|usvsthem|utoukond|vanvan|vliner|vshoot|waterski|wits|wldcourt|wmatch|wofch|woodpeck|worldwar|ws|wschamp|wtennis|wwallyj)'
